...
contract ERC721Ax is ERC721A, LockRegistry {
	...
	function transferFrom(address _from, address _to, uint256 _tokenId) public payable override virtual {
		require(isUnlocked(_tokenId), "Token is locked");
		ERC721A.transferFrom(_from, _to, _tokenId);
	}

	function safeTransferFrom(address _from, address _to, uint256 _tokenId, bytes memory _data) public payable override virtual {
		require(isUnlocked(_tokenId), "Token is locked");
